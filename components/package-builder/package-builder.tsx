...
import { Check, Building2, Car, Plane, Stethoscope, CalendarIcon, Star, Wifi, Coffee, Utensils, Dumbbell } from 'lucide-react'
    ...
    <div className="container mx-auto py-10">
      ...
      <Card className="w-full max-w-4xl mx-auto">
        ...
        <CardFooter className="flex justify-between">
          {currentStep !== 0 && steps[currentStep].id !== 'flights' && <Button onClick={handleBack}>Back</Button>}
      ...
      <Card className="w-full max-w-4xl mx-auto mt-6">
        ...
        <CardContent>
          <p className="text-2xl font-bold">Total: ${calculateTotalCost(selectedPrice!, skipFlights, selectedDepartureFlight, selectedReturnFlight, flightType, selectedAccommodation, accommodationNights, includeAirportTransfer, includeClinicTransfer)}</p>
        </CardContent>
      </Card>
    </div>
  )
...
export const calculateTotalCost = (
	...
	if (!skipFlights) {
		if (selectedDepartureFlight) {
			const departureFlight = flightOptions.find(f => 
		...
		if (flightType === 'roundTrip' && selectedReturnFlight) {
			const returnFlight = flightOptions.find(f => 
